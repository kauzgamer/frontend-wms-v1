...
import { z } from 'zod'
import { AuthContext, type User, type AuthContextType } from './auth-context-base'
...
export function AuthProvider({ children }: AuthProviderProps) {
  ...
  const value: AuthContextType = { user, token, login, logout, isAuthenticated: !!token, isLoading }
