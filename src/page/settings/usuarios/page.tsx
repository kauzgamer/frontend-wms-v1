    ...
    <div className="group relative">
      <div className="absolute top-2 right-2 z-10">
        ...
        {open && (
          ...
          >
            <button
              className="w-full text-left text-sm px-3 py-2 hover:bg-muted/70"
            ...
            <button
              className="w-full text-left text-sm px-3 py-2 hover:bg-muted/70 text-red-600"
              onClick={() => setOpen(false)}
            >
              Desativar
            </button>
      ...
      <Card className="border shadow-sm p-0 overflow-hidden transition hover:shadow-md focus-within:ring-2 focus-within:ring-[#0c9abe]">
        <div className="flex flex-col">
          <div className="flex items-start justify-between px-5 pt-4 pr-10">
            ...
            <span className="ml-2 inline-flex items-center rounded-full bg-[#009c80] text-white text-[10px] font-semibold px-3 py-[4px] leading-none shadow-sm">
              {user.status}
            </span>
          </div>
          <div className="mt-3 px-5 pb-4 border-t pt-3 space-y-2">
            ...
            >
              ...
              <span className="leading-snug max-h-10 overflow-auto custom-scroll thin-scrollbar break-all">
                {user.email}
              </span>
            </div>
          </div>
