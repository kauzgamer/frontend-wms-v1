    ...
    <div className="p-6 space-y-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <div className="relative">
              <label htmlFor="customer-search" className="sr-only">Pesquisar</label>
              <input id="customer-search" name="search" autoComplete="off" className="border rounded pl-8 pr-2 py-1 text-sm w-64" placeholder="Pesquisar por nome ou documento" value={q} onChange={(e) => setQ(e.target.value)} />
      ...
      <div className="flex gap-3 items-end">
        <div className="flex flex-col">
          <label htmlFor="customer-status" className="text-sm">Situação</label>
          <select id="customer-status" name="status" className="border rounded px-2 py-1" value={status} onChange={(e) => { setStatus(e.target.value as 'ATIVO' | 'INATIVO' | 'TODOS'); setPage(1) }}>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2 text-sm">
            <label htmlFor="customer-page-size" className="text-gray-600">Exibir</label>
            <select id="customer-page-size" name="pageSize" className="border rounded px-2 py-1" value={pageSize} onChange={(e)=>{ const v=parseInt(e.target.value,10); setPageSize(v); setPage(1) }}>
