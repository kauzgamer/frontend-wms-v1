...
export function OrganizacaoPage() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      // Só adiciona CNPJ se tiver 14 dígitos
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <Card className="p-5 md:col-span-2 flex flex-col gap-5">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="flex flex-col gap-1">
              <label className="text-xs font-medium uppercase tracking-wide">CNPJ (opcional)</label>
              <input
                value={form.cnpj}
              ...
              {form.cnpj && form.cnpj.length > 0 && form.cnpj.length !== 14 && (
                <span className="text-xs text-red-600">CNPJ deve ter 14 dígitos</span>
              )}
            </div>
            <div className="flex flex-col gap-1">
